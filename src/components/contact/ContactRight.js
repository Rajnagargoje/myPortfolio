...
const ContactRight = () => {
  ...
  return (
    <div className=" w-full lgl:w-[60%] h-full py-10 p-8 bg-gradient-to-r from-[#1e2024] to-[#23272b] flex flex-col gap-8 rounded-shadow-shadowOne">
      <form className="w-full flex flex-col gap-4 md:gap-6 py-2 md:py-4">
        {errMsg && (
          <p
      ...
      shadow-shadowOne text-center text-green-500 text-base tracking-wide animate-bounce"
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <textarea
            ...
            value={message}
            className={`${errMsg === "message is required" && "outline-designolor"
              } contactTextArea`}
            cols="30"
            rows="8"
          ></textarea>
